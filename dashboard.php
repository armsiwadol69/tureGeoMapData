...
?>
                        ...
                        <div class="mt-3 w-100">
                            <hr class="mt-4">
                            <div class="btn-toolbar w-100" style="justify-content: center; display: flex;"
                        ...
                        <form class="" id="newwish_form" action="newticket.php" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="site" name="site"
                                    aria-describedby="nameHelp" maxlength="512" autocomplete="new-name" required>
                            </div>
                            <div class="mb-3">
...
?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="date" name="date" aria-describedby="tagHelp"
                                    autocomplete="new-tag" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control" id="time" name="time" step="1"
                                    aria-describedby="tagHelp" autocomplete="new-tag" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="duration" class="form-label">Status<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="input-group mb-3">
                                <textarea class="form-control" rows="4" cols="50" maxlength="500" name="detail"
                                    id="detail" aria-label="With textarea" required autocomplete="new-wish"></textarea>
                            </div>
                            <div id="tagHelp" class="form-text my-2">Ticket ID is Auto Generate.</div>
                            <input type="submit" class="btn btn-lg w-100 btn_newWish text-white" id="btnSubmit"
                                value="Open New Ticket" name="submit_button">
                        </form>
                    </div>
                </div>
            </div>
